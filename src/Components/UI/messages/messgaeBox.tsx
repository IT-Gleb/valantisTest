function MessageBox({
  ...
  return (
    <>
      ...
      <div className="absolute w-[50%] bg-slate-200 border-[6px] border-slate-700 rounded-md text-slate-50 shadow-lg shadow-black/80 left-[50%] top-[50%] z-10 translate-x-[-50%] translate-y-[-50%]">
